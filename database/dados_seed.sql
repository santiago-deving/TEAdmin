...
VALUES
-- passadas (status 2 = presente, 3 = ausente)
(3, 2, 1, 2, '2026-01-05', '08:00'),
(1, 4, 2, 3, '2026-01-08', '09:30'),
(5, 1, 1, 2, '2026-01-13', '11:00'),
(2, 3, 2, 2, '2026-01-19', '14:00'),
(4, 2, 1, 3, '2026-01-22', '16:00'),
(6, 4, 2, 2, '2026-01-28', '08:30'),
(1, 1, 1, 2, '2026-02-03', '10:00'),
(3, 3, 2, 3, '2026-02-10', '13:00'),
(5, 2, 1, 2, '2026-02-17', '15:30'),
(2, 4, 2, 2, '2026-02-24', '09:00'),
(6, 1, 1, 3, '2026-03-03', '11:30'),
(4, 3, 2, 2, '2026-03-10', '14:00'),
(1, 2, 1, 2, '2026-03-18', '08:30'),
(3, 4, 2, 2, '2026-03-25', '10:00'),
(5, 3, 1, 3, '2026-04-01', '09:00'),
(2, 1, 2, 2, '2026-04-07', '14:30'),
(6, 2, 1, 2, '2026-04-14', '11:00'),
(4, 4, 2, 3, '2026-04-21', '16:00'),
(1, 3, 1, 2, '2026-04-28', '08:00'),
(3, 1, 2, 2, '2026-05-05', '13:30'),
(5, 4, 1, 3, '2026-05-06', '10:00'),
(2, 2, 2, 2, '2026-05-07', '09:00'),
(6, 3, 1, 2, '2026-05-08', '14:00'),

-- futuras - semana de 14/05 a 20/05
(1, 2, 1, 1, '2026-05-14', '08:00'),
(4, 1, 2, 1, '2026-05-14', '10:30'),
(3, 4, 1, 1, '2026-05-15', '09:00'),
(6, 3, 2, 1, '2026-05-15', '14:00'),
(2, 2, 1, 1, '2026-05-16', '11:00'),
(5, 1, 2, 1, '2026-05-16', '15:30'),
(1, 3, 1, 1, '2026-05-19', '08:30'),
(4, 2, 2, 1, '2026-05-19', '13:00'),
(3, 1, 1, 1, '2026-05-20', '10:00'),
(6, 4, 2, 1, '2026-05-20', '16:00');
